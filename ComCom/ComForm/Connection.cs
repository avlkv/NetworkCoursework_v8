                    ...
                    if (IsConnected())
                    {
                        ...
                        else
                        {
                            ...
                            for (i = 0; i < parts; i++)
                            {
                                ...
                                {
                                    MessageBox.Show("Передача файла нарушена. 5");
                                }
                                ...
                                else if (!IsConnected())
                                {
                                    ...
                                    while (!IsConnected())
                                    {
                                        result = MessageBox.Show("Соединение прервано. Передача нарушена.2 \n"
                                        + "SuccessfulFrameNumber: " + SuccessfulFrameNumber.ToString()
